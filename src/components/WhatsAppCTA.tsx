...
export default function WhatsAppCTA() {
  return (
    <motion.a
      ...
      transition={{ delay: 2, type: "spring", stiffness: 240, damping: 22 }}
      whileHover={{ scale: 1.1 }}
      whileTap={{ scale: 0.93 }}
      className="fixed bottom-6 right-6 z-40 w-[52px] h-[52px] rounded-full flex items-center justify-center bg-[#25D366] shadow-[0_4px_20px_rgba(37,211,102,0.38)]"
    >
      {/* Pulse ring */}
